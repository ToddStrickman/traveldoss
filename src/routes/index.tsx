    ...
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground selection:bg-seal/40">
      ...
      <main className="relative z-10 mx-auto flex min-h-screen max-w-[1400px] flex-col items-center justify-center px-6 py-16 text-center md:pl-32 md:pr-[340px]">
        ...
        >
          <Link
            to="/templates"
            className="group relative inline-flex items-center gap-5 border-y border-ink/20 py-5 pl-2 pr-1 text-[11px] font-medium uppercase tracking-[0.4em] text-ink transition-colors duration-500 hover:border-seal hover:text-seal"
          >
            <span className="text-ink/40 transition-colors group-hover:text-seal">01</span>
            <span>Pick a TravelDoss Template</span>
            <span className="inline-flex h-9 w-9 items-center justify-center border border-ink/20 transition-all duration-500 group-hover:border-seal group-hover:bg-seal group-hover:text-paper">
