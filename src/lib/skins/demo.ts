...
export const DEMO_BLOCKS: Block[] = [
  ...
  { kind: "place", name: "Memmo Príncipe Real", category: "stay", note: "Quiet courtyard, rooftop bar." },
  { kind: "place", name: "Cervejaria Ramiro", category: "eat", address: "Av. Almirante Reis 1", note: "Tiger prawns. Get the steak sandwich after." },
